...
In [part 1](http://perso.heavyberry.com/articles/2024-08/go-bt-1) we looked at parsing bencoded data. Let's put this to good use and start looking at `.torrent` files - we'll finish by creating our own (from scratch!).
